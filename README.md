...
- `/src` contains the working (permanent) .html, .css & .js files (with comments, indentation). These end up in `/docs` as minified copies (the pages served to visitors, the source not as human readable). 
